...
const EnvSchema = z.object({
  ...
  OPENHANDS_BIN: z.string().default("openhands"),
  OPENHANDS_PYTHON_BIN: z.string().optional().default(""),
  ...
  CONTEXT_AUTO_SUMMARY_ENABLED: booleanParam(false),
