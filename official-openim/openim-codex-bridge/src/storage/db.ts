...
function migrate(db: BridgeDatabase): void {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS codex_runtime_scope_configs (
      id TEXT PRIMARY KEY,
    ...
    CREATE UNIQUE INDEX IF NOT EXISTS idx_codex_runtime_scope_configs_scope
      ON codex_runtime_scope_configs(scope_type, scope_key);
